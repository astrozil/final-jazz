...
class SuggestedSongsOfFavouriteArtistsPlaylistScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocBuilder<PlaylistBloc, PlaylistLoaded>(
        builder: (context, state) {
          if (state.isLoading && state.suggestedSongsOfFavouriteArtists.isEmpty) {
            return const Center(
              child: CircularProgressIndicator(color: Colors.white),
            );
          } else if (state.suggestedSongsOfFavouriteArtists.isNotEmpty) {
