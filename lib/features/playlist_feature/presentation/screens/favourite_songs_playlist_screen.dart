    ...
    return Scaffold(
      ...
      body: BlocBuilder<PlaylistBloc, PlaylistState>(
        builder: (context, state) {
          if (state is PlaylistLoaded && state.isLoading && state.favouriteSongsPlaylist.isEmpty) {
            return const Center(
              child: CircularProgressIndicator(color: Colors.white),
            );
          } else if (state is PlaylistLoaded && state.favouriteSongsPlaylist.isNotEmpty) {
            final songs = state.favouriteSongsPlaylist;
            if (songs.isEmpty) {
              return const Center(
                child: Text(
                    "No favourite tracks available",
